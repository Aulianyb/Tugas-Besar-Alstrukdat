...
boolean validRock(Word word) {
    return ((currentWord.TabWord[0] == 'R' || currentWord.TabWord[0] == 'r') && (currentWord.TabWord[1] == 'O' || currentWord.TabWord[1] == 'o') && (currentWord.TabWord[2] == 'C' || currentWord.TabWord[2] == 'c') && (currentWord.TabWord[3] == 'K' || currentWord.TabWord[3] == 'k'));
}

boolean validPaper(Word word) {
    return ((currentWord.TabWord[0] == 'P' || currentWord.TabWord[0] == 'p') && (currentWord.TabWord[1] == 'A' || currentWord.TabWord[1] == 'a') && (currentWord.TabWord[2] == 'P' || currentWord.TabWord[2] == 'p') && (currentWord.TabWord[3] == 'E' || currentWord.TabWord[3] == 'e') && (currentWord.TabWord[4] == 'R' || currentWord.TabWord[4] == 'r'));
}

boolean validScissor(Word word) {
    return ((currentWord.TabWord[0] == 'S' || currentWord.TabWord[0] == 's') && (currentWord.TabWord[1] == 'C' || currentWord.TabWord[1] == 'c') && (currentWord.TabWord[2] == 'I' || currentWord.TabWord[2] == 'i') && (currentWord.TabWord[3] == 'S' || currentWord.TabWord[3] == 's') &&
